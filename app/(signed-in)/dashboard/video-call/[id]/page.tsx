...
function VideoCall() {
  ...
  if (callingState === CallingState.RECONNECTING) {
    return (
      <StatusCard
        title="Reconnecting..."
        description="Attempting to rejoin the call"
          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className=" text-gray-600">
                Share this link with otehr tp invite them to the call
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:wring-offset-2
                        whitespace-nowrap"
                    >
                        {copied ? (
                            <>
